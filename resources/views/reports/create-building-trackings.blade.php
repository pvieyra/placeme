  ...
  <div>
    <div class="card">
      <div class="card-content">
        <div class="card-title">Reporte por propiedad</div>
        <form action="{{ route('export-report-building-trackings') }}" method="GET">
          <div class="row">
            <div class="col s12 m6">
              <label for="buildings">Propiedad</label>
              <select class="js-states browser-default required auto-select" tabindex="-1" style="width: 100%" id="buildings" name="building_id" >
              </select>
            </div>
          </div>
          <div class="row">
  ...
  <script>
      ...
      $(document).ready(function() {
          $('#buildings').select2({
              ...
              ajax: {
                  url: '{{ route('building-reports.select')}}',
                  type: 'POST',
                  dataType: 'json',
                  delay:500,
