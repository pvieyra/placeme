...
<head>
  <!-- Title -->
  <title>Place Me! | Cambio de contraseña </title>
        ...
        <div class="col s12 m6 l4 offset-l4 offset-m3">
          <div class="card white darken-1">
            <div class="card-content ">
              ...
              <div class="row">
                <form action="{{ route('users.change.password', Auth::user()) }}" method="POST" class="col s12">
                  @method('PUT')
                  @csrf
                  <div class="input-field col s12">
                    <input id="password" name="password" type="password" class="validate @error('password') invalid @enderror">
                  ...
                  <div class="col s12 right-align m-t-sm">
                    <input type="submit"  class="waves-effect waves-light btn teal" value="Cambiar" />
                  </div>
                </form>
              </div>
            </div>
