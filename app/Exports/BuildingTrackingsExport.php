...
class BuildingTrackingsExport implements FromView {
  public function view(): View {
    ...
    $trackings =  Tracking::join('users', 'trackings.user_id', '=', 'users.id')
      ...
      ->where('trackings.building_id', '=', session('building_id'))
      ...
      ->select('trackings.id','users.email',
        ...
        'customers.email as customer_email', 'buildings.building_code','buildings.address', 'trackings.contact_type',
    ...
    /*->paginate(10);*/
    return view('exports.building-trackings', compact('trackings'));
  }
}
